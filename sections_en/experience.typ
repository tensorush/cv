...
#cvEntry(
  ...
  society: [#link("https://github.com/Stabl-Energy")[#gh #hSpc() STABL Energy] #hDot() Internship],
...
#cvEntry(
  ...
  society: [#link("https://github.com/phygitalism")[#gh #hSpc() PHYGITALISM] #hDot() Full-time],
