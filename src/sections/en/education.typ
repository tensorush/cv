...
#cvEntry(
  ...
  host: [#link("https://www.tum.de/en/studies/degree-programs/detail/informatics-master-of-science-msc")[#lk #hSpc() Technical University of Munich] #hDot() Full-time],
...
#cvEntry(
  ...
  host: [#link("https://en.mai.ru/education/international-master/russian-master-programs/mathematics-and-computer-science/")[#lk #hSpc() Moscow Aviation Institute] #hDot() Part-time],
...
#cvEntry(
  ...
  host: [#link("https://spb.hse.ru/en/ba/interbac/")[#lk #hSpc() Higher School of Economics] #hDot() Full-time],
