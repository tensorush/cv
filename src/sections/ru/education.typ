...
#cvEntry(
  ...
  host: [#link("https://www.tum.de/en/studies/degree-programs/detail/informatics-master-of-science-msc")[#lk #hSpc() Технический Университет Мюнхена] #hDot() Очная форма],
...
#cvEntry(
  ...
  host: [#link("https://en.mai.ru/education/international-master/russian-master-programs/mathematics-and-computer-science/")[#lk #hSpc() Московский Авиационный Институт] #hDot() Вечерняя форма],
...
#cvEntry(
  ...
  host: [#link("https://spb.hse.ru/en/ba/interbac/")[#lk #hSpc() Высшая Школа Экономики] #hDot() Очная форма],
