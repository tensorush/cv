...
#let headerSummary = (
  "en": "Open to C++/Go/Zig developer positions, especially working on distributed systems.",
  "ru": "Готов к разработке на C++/Go/Zig, особенно в рамках распределенных систем.",
)
