...
#let headerSummary = (
  "en": "Open to remote Go Developer positions, especially working on distributed systems.",
  "ru": "Готов к удаленной работе на Go, особенно в контексте распределенных систем.",
)
